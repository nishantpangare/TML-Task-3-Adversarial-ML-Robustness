...
API_KEY = "4ffd0e8bba3b9e8977c5c163c465fd4f"  # replace with your actual API key

MODEL_PATH = "/home/atml_team013/tml3/model20.pt"  # replace with your actual model path
